...
# client1 = Client(forename="Tim", surname="Mole", dob=date(1997, 3, 11), address="12 Lindsey St", email="tm@email.com", fitness_level=9)
...
client2 = Client(forename="Keith", surname="Gill", dob=date(1997, 3, 11), address="212 Friday St", email="kg@email.com", fitness_level=3)
